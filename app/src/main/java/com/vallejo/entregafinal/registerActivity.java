...
public class registerActivity extends AppCompatActivity{
    ...
    private boolean validateFields(String email, String username, String password) {
        if (email.isEmpty()) {
            emailEditText.setError("Por favor ingrese un correo electrónico");
            emailEditText.requestFocus();
            return false;
        }

        if (username.isEmpty()) {
            usernameEditText.setError("Por favor ingrese un nombre de usuario");
            usernameEditText.requestFocus();
            return false;
        }

        if (password.isEmpty()) {
            passwordEditText.setError("Por favor ingrese una contraseña");
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // Redirigir a la siguiente actividad (chatActivity)
