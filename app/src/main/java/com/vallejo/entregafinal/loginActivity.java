                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Inicio de sesión correcto, actualizar la interfaz con la información del usuario que ha iniciado sesión
                            ...
                            // Sesión fallida, muestra una alerta al usuario.
                            Toast.makeText(loginActivity.this, "Credenciales incorrectas. Inténtalo de nuevo",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
